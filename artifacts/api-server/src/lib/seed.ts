...
export async function seed() {
  ...
  const desiredBundles = [
    { credits: 200, priceCents: 4180, sortOrder: 0, isActive: true },
    { credits: 400, priceCents: 7940, sortOrder: 1, isActive: true },
    { credits: 800, priceCents: 15048, sortOrder: 2, isActive: true },
  ];
